...
guide = '''# 🔧 FIX FOR WINDOWS DPAPI ERROR
...
with open('DPAPI_FIX_GUIDE.md', 'w', encoding='utf-8') as f:
    f.write(guide)

print("✅ Created DPAPI_FIX_GUIDE.md")
print("\n" + "="*70)
print("🔴 WINDOWS DPAPI COOKIE ERROR - HERE'S THE FIX")
print("="*70)
print("""
The error you're seeing is because Chrome on Windows encrypts cookies
with DPAPI and yt-dlp can't decrypt them.
...
2. Go to instagram.com in Chrome (login if needed)

3. Click extension → Export → Save as cookies.txt

4. Move cookies.txt to:
   D:\\Instagram_video_downloader\\cookies.txt

5. Run: python app_with_cookies.py

6. Visit: http://localhost:5000

DONE! ✅

📖 Read DPAPI_FIX_GUIDE.md for detailed instructions
""")
print("="*70)
